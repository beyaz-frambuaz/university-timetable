...
public class SchedulesController implements SchedulesApi {
    ...
    @Override
    public CollectionModel<EntityModel<Schedule>> findByDate(LocalDate date,
            Long professorId, Long groupId, Long courseId, Long auditoriumId) {
        ...
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).findByDate(date,
                        professorId, groupId, courseId,
                        auditoriumId)).withSelfRel());
    }

    @Override
    public CollectionModel<EntityModel<Schedule>> findByWeek(int week,
            Long professorId, Long groupId, Long courseId, Long auditoriumId) {
        ...
        List<EntityModel<Schedule>> models = getEntityModels(
                ...
                monday, friday);
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).findByWeek(week,
                        professorId, groupId, courseId,
                        auditoriumId)).withSelfRel());
    }

    @Override
    public CollectionModel<EntityModel<Schedule>> findByMonth(int month,
            Long professorId, Long groupId, Long courseId, Long auditoriumId) {
        ...
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).findByMonth(month,
                        professorId, groupId, courseId,
                        auditoriumId)).withSelfRel());
    }
    ...
    @Override
    public CollectionModel<EntityModel<Schedule>> reschedule(long id,
            Schedule rescheduled, boolean recurring) {
        ...
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).reschedule(id, rescheduled,
                        recurring)).withSelfRel()
                        .expand(id, rescheduled, recurring),
                linkTo(methodOn(SchedulesApi.class).findById(id)).withRel(
                        "schedule"));
    }
    ...
    public CollectionModel<EntityModel<Auditorium>> findAvailableAuditoriums(
        ...
        List<EntityModel<Auditorium>> models =
                timetableFacade.getAvailableAuditoriums(schedule.getDate(),
                        ...
                        .collect(Collectors.toList());
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).findAvailableAuditoriums(
                        id)).withSelfRel());
    }
    ...
    public CollectionModel<EntityModel<Professor>> findAvailableProfessors(
        ...
        List<EntityModel<Professor>> models =
                timetableFacade.getAvailableProfessors(schedule.getDate(),
                        ...
                        .collect(Collectors.toList());
        return new CollectionModel<>(models,
                linkTo(methodOn(SchedulesApi.class).findAvailableProfessors(id))
                        .withSelfRel());
    }

    @Override
    public CollectionModel<EntityModel<ReschedulingOption>> findOptions(long id,
            LocalDate date, Integer week) {
        ...
        return new CollectionModel<>(options,
                linkTo(methodOn(SchedulesApi.class).findOptions(id, date, week))
                        .withSelfRel());
    }
