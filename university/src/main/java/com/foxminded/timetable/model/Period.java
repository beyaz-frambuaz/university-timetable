...
public enum Period {
    FIRST       (LocalTime.of(8, 15),   LocalTime.of(9, 45)),
    SECOND      (LocalTime.of(10, 0),   LocalTime.of(11, 30)),
    THIRD       (LocalTime.of(12, 30),  LocalTime.of(14, 0)),
    ...
    public String getTime() {
        return begins.format(formatter) + " - "
                + ends.format(formatter);
    }
    
    @Override
    public String toString() {
        return this.getTime() + " " + this.name();
    }
}
