...
public class MenuManager {
    ...
    private void displayTwoWeekSchedule() {
    ...
    private List<Schedule> displaySchedule() {
        ...
        switch (scheduleMode) {
            ...
            case 2:
                ...
                log.debug("User chose to view schedule for week {}",
                        weekNumber);
            ...
            case 3:
                ...
                LocalDate firstOfMonth = timetable.getSemesterCalendar()
                        .getFirstSemesterMondayOfMonth(month);
                LocalDate lastOfMonth = timetable.getSemesterCalendar()
                        .getLastSemesterFridayOfMonth(month);
    ...
    private List<Schedule> displayScheduleForTarget(LocalDate start,
        ...
        switch (scheduleTarget) {
            ...
            case 4:
                ...
                List<Schedule> schedules = timetable.getScheduleInRange(start,
                        end);
    ...
    private List<Schedule> displayProfessorSchedule(LocalDate start,
        ...
        log.debug("User chose to view schedule for professor ID {}",
                professorId);
        List<Schedule> professorSchedule = timetable.getProfessorSchedule(
                professor, start, end);
    ...
    private void displayAvailableAuditoriums() {
        ...
        List<Auditorium> availableAuditoriums =
                timetable.getAvailableAuditoriums(
                date, period);
        ...
        switch (choice) {
            case 1:
                ...
                LocalDate date = inputCollector.requestDate(
                        timetable.getSemesterCalendar().getStartDate(),
                        timetable.getSemesterCalendar().getEndDate());
                log.debug("User chose to view rescheduling options on {}",
                        date);
    ...
    private void rescheduleByOption(Schedule candidate, LocalDate targetDate,
        ...
        switch (choice) {
            case 1:
                ...
                System.out.println(printer.printSchedules(
            ...
            case 2:
                ...
                List<Schedule> affectedSchedules =
                        timetable.reschedulePermanently(
                        candidate, targetDate, targetOption);
    ...
    private void substituteProfessor() {
        ...
        Professor substitute = availableProfessors.stream()
                ...
                .findFirst()
                .get();
        log.debug("User chose to substitute professor ID {} with professor ID "
                        + "{} for schedule ID {}",
                schedule.getProfessor().getId(),
                professorId, schedule.getId());

        schedule = timetable.substituteProfessor(schedule, substitute);
        System.out.println("Done!\nHere is how this schedule looks like now:");
        System.out.println(
                printer.printSchedules(Collections.singletonList(schedule)));
    }
