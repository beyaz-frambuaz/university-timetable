...
public class SpringdocTest {
    ...
    void shouldDisplaySwaggerUiPage() throws Exception {
        ...
        MvcResult mvcResult = mvc.perform(get("/swagger-ui/index.html")).andExpect(status().isOk()).andReturn();
        assertThat(mvcResult.getResponse().getContentAsString()).contains("Swagger UI");
    }
