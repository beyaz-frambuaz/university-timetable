...
class StudentsControllerTest {
    ...
    void findAllShouldRequestFromService() throws Exception {
        ...
        given(timetableFacade.getStudents()).willReturn(Collections.singletonList(student));
        ...
        mvc.perform(get(baseUrl).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$._embedded.studentList[0].group").value(student.getGroup()))
    ...
    void addNewShouldSaveAndReturnCreated() throws Exception {
        ...
        given(timetableFacade.saveStudent(any(Student.class))).willReturn(student);
    ...
    void findByIdShouldRequestFromService() throws Exception {
        ...
        mvc.perform(get(baseUrl + student.getId()).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(student.getId()))
                .andExpect(jsonPath("$.firstName").value(student.getFirstName()))
                .andExpect(jsonPath("$.lastName").value(student.getLastName()))
    ...
    void editByIdShouldCallServiceToSave() throws Exception {
        ...
        mvc.perform(put(baseUrl + student.getId()).contentType(MediaType.APPLICATION_JSON).content(payload))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(student.getId()))
                .andExpect(jsonPath("$.firstName").value(student.getFirstName()))
                .andExpect(jsonPath("$.lastName").value(student.getLastName()))
    ...
    void deleteByIdShouldReturnNotImplemented() throws Exception {
        ...
        mvc.perform(delete(baseUrl + student.getId())).andExpect(status().isNotImplemented());
    }
