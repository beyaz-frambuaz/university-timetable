...
public class TimetableFacadeTest {
    ...
    private final ReschedulingOption option = new ReschedulingOption(id, DayOfWeek.MONDAY, Period.FIRST, auditorium);
    private final ScheduleTemplate template = new ScheduleTemplate(id, false, DayOfWeek.MONDAY, Period.FIRST,
    ...
    private final Professor invalidProfessor = new Professor(invalidId, " ", " ");
    private final Student invalidStudent = new Student(invalidId, " ", " ", null);
    private final ReschedulingOption invalidOption = new ReschedulingOption(invalidId, null, null, null);
    private final ScheduleTemplate invalidTemplate = new ScheduleTemplate(invalidId, false, null, null,
            invalidAuditorium, invalidCourse, invalidGroup, invalidProfessor);
    private final Schedule invalidSchedule = new Schedule(invalidId, invalidTemplate, null, null, null,
            invalidAuditorium, invalidCourse, invalidGroup, invalidProfessor);
    ...
    public void saveAuditoriumShouldDelegateToAuditoriumService() {
        ...
        given(auditoriumService.save(any(Auditorium.class))).willReturn(auditorium);
    ...
    public void saveAuditoriumsShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveAuditoriums(Collections.singletonList(invalidAuditorium)));
    }
    ...
    public void getAvailableAuditoriumsShouldDelegateToAuditoriumService() {
        ...
        List<Auditorium> expected = Collections.singletonList(auditorium);
        given(auditoriumService.findAvailableFor(any(LocalDate.class), any(Period.class))).willReturn(expected);

        List<Auditorium> actual = timetableFacade.getAvailableAuditoriums(date, period);
    ...
    public void saveCoursesShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveCourses(Collections.singletonList(invalidCourse)));
    }
    ...
    public void saveGroupsShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveGroups(Collections.singletonList(invalidGroup)));
    }
    ...
    public void getGroupedStudentsShouldRequestAllGroupsAndStudentsAndGroupThem() {
        ...
        given(groupService.findAll()).willReturn(Arrays.asList(groupOne, groupTwo));
        given(studentService.findAll()).willReturn(Arrays.asList(studentOne, studentTwo));
    ...
    public void saveProfessorShouldDelegateToProfessorService() {
        ...
        given(professorService.save(any(Professor.class))).willReturn(professor);
    ...
    public void saveProfessorsShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveProfessors(Collections.singletonList(invalidProfessor)));
    }
    ...
    public void getAvailableProfessorsShouldDelegateToProfessorService() {
        ...
        Period period = Period.FIRST;
        List<Professor> expected = Collections.singletonList(professor);
        given(professorService.findAvailableFor(any(LocalDate.class), any(Period.class))).willReturn(expected);

        List<Professor> actual = timetableFacade.getAvailableProfessors(date, period);
    ...
    public void saveOptionsShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveOptions(Collections.singletonList(invalidOption)));
    }
    ...
    public void getOptionsForWeekShouldDelegateAppropriateCallsToUnderlyingServices() {
        ...
        given(templateService.findAllForWeek(anyBoolean())).willReturn(templates);

        List<Schedule> schedules = Collections.emptyList();
        given(scheduleService.findGeneratedInRange(any(LocalDate.class), any(LocalDate.class))).willReturn(schedules);
    ...
    public void getOptionsForWeekShouldReturnEmptyListGivenNonSemesterWeek() {
        ...
        List<ReschedulingOption> actual = timetableFacade.getOptionsForWeek(schedule, week);
    ...
    public void getOptionsForDateShouldDelegateAppropriateCallsToUnderlyingServices() {
        ...
        LocalDate date = LocalDate.MAX;
        given(semesterCalendar.isSemesterDate(any(LocalDate.class))).willReturn(true);
        given(semesterCalendar.getWeekParityOf(any(LocalDate.class))).willReturn(true);

        List<ScheduleTemplate> templates = Collections.emptyList();
        given(templateService.findAllForDay(anyBoolean(), any(DayOfWeek.class))).willReturn(templates);

        List<Schedule> schedules = Collections.emptyList();
        given(scheduleService.findGeneratedInRange(any(LocalDate.class), any(LocalDate.class))).willReturn(schedules);

        List<ReschedulingOption> options = Collections.emptyList();
        given(optionService.findAllForDay(any(DayOfWeek.class))).willReturn(options);
    ...
    public void getOptionsForDateShouldFilterOutOptionsWithBusyAuditoriums() {
        ...
        ReschedulingOption availableOption = new ReschedulingOption(1L, day, period, availableAuditorium);
        ReschedulingOption busyOptionOne = new ReschedulingOption(2L, day, period, busyAuditoriumOne);
        ReschedulingOption busyOptionTwo = new ReschedulingOption(3L, day, period, busyAuditoriumTwo);
        List<ReschedulingOption> options = Arrays.asList(availableOption, busyOptionOne, busyOptionTwo);
        ...
        given(scheduleService.findGeneratedInRange(any(LocalDate.class), any(LocalDate.class))).willReturn(
        ...
        given(templateService.findAllForDay(anyBoolean(), any(DayOfWeek.class))).willReturn(
        ...
        List<ReschedulingOption> actual = timetableFacade.getOptionsForDate(candidate, date);

        assertThat(actual).containsOnly(availableOption).doesNotContain(busyOptionOne, busyOptionTwo);
    }
    ...
    public void getOptionsForDateShouldFilterOutOptionsInPeriodsWithBusyGroupOrProfessor() {
        ...
        ReschedulingOption availableOption = new ReschedulingOption(1L, day, availablePeriod, auditorium);
        ReschedulingOption busyOptionOne = new ReschedulingOption(2L, day, busyPeriodOne, auditorium);
        ReschedulingOption busyOptionTwo = new ReschedulingOption(3L, day, busyPeriodTwo, auditorium);
        ReschedulingOption busyOptionThree = new ReschedulingOption(4L, day, busyPeriodThree, auditorium);
        ReschedulingOption busyOptionFour = new ReschedulingOption(5L, day, busyPeriodFour, auditorium);
        List<ReschedulingOption> options = Arrays.asList(availableOption, busyOptionOne, busyOptionTwo, busyOptionThree,
                busyOptionFour);
        ...
        given(templateService.findAllForDay(anyBoolean(), any(DayOfWeek.class))).willReturn(
                Arrays.asList(templateOne, templateTwo));
        ...
        List<ReschedulingOption> actual = timetableFacade.getOptionsForDate(schedule, date);

        assertThat(actual).containsOnly(availableOption)
                .doesNotContain(busyOptionOne, busyOptionTwo, busyOptionThree, busyOptionFour);
    }
    ...
    public void getOptionsForDateShouldReturnEmptyListGivenNonSemesterDate() {
        ...
        LocalDate date = LocalDate.MAX;
        given(semesterCalendar.isSemesterDate(any(LocalDate.class))).willReturn(false);
    ...
    public void saveSchedulesShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveSchedules(Collections.singletonList(invalidSchedule)));
    }
    ...
    public void getScheduleForShouldDelegateToScheduleService() {
        ...
        given(scheduleService.findAllFor(any(SchedulePredicate.class), any(LocalDate.class),
                any(LocalDate.class))).willReturn(expected);

        List<Schedule> actual = timetableFacade.getScheduleFor(predicate, date, date);
    ...
    public void getScheduleInRangeShouldDelegateToScheduleService() {
        ...
        LocalDate date = LocalDate.MAX;
        List<Schedule> expected = Collections.emptyList();
        given(scheduleService.findAllInRange(any(LocalDate.class), any(LocalDate.class))).willReturn(expected);
    ...
    public void saveTemplateShouldDelegateToTemplateService() {
        ...
        given(templateService.save(any(ScheduleTemplate.class))).willReturn(template);
    ...
    public void saveTemplatesShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveTemplates(Collections.singletonList(invalidTemplate)));
    }
    ...
    public void saveStudentsShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.saveStudents(Collections.singletonList(invalidStudent)));
    }
    ...
    public void getCourseAttendeesShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.getCourseAttendees(invalidCourse, invalidProfessor));
    }
    ...
    public void getCourseAttendeesShouldDelegateToGroupAndStudentServices() {
        ...
        given(groupService.findAllAttendingProfessorCourse(any(Course.class), any(Professor.class))).willReturn(
                professorGroups);
        List<Student> expected = Collections.emptyList();
        given(studentService.findAllInGroups(anyList())).willReturn(expected);

        List<Student> actual = timetableFacade.getCourseAttendees(course, professor);

        then(groupService).should().findAllAttendingProfessorCourse(course, professor);
    ...
    public void substituteProfessorShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.substituteProfessor(invalidSchedule, invalidProfessor));
    }
    ...
    public void substituteProfessorShouldSetProfessorAndDelegateSaveToService() {
        ...
        Schedule actual = timetableFacade.substituteProfessor(expected, substitute);
    ...
    public void rescheduleOnceShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.rescheduleSingle(invalidSchedule, null, invalidOption));
    }
    ...
    public void rescheduleOnceShouldSetNewScheduleAttributesAndDelegateSaveToService() {
        ...
        ReschedulingOption option = new ReschedulingOption(id, day, period, newAuditorium);
        Schedule expected = new Schedule(schedule);

        given(scheduleService.save(any(Schedule.class))).willReturn(expected);

        Schedule actual = timetableFacade.rescheduleSingle(expected, date, option);
    ...
    public void reschedulePermanentlyShouldValidate() {
        ...
        assertThatExceptionOfType(ConstraintViolationException.class).isThrownBy(
                () -> timetableFacade.rescheduleRecurring(invalidSchedule, null, invalidOption));
    }
    ...
    public void reschedulePermanentlyTest() {
        ...
        ScheduleTemplate underlyingTemplate = new ScheduleTemplate(id, true, DayOfWeek.MONDAY, Period.FIRST, auditorium,
                course, group, professor);

        Schedule candidate = new Schedule(underlyingTemplate, LocalDate.MAX);

        given(templateService.findById(anyLong())).willReturn(Optional.of(underlyingTemplate));

        LocalDate date = LocalDate.MIN;
        DayOfWeek newDay = DayOfWeek.WEDNESDAY;
        Period newPeriod = Period.THIRD;
        Auditorium newAuditorium = new Auditorium(id, "new");
        ReschedulingOption option = new ReschedulingOption(id, newDay, newPeriod, newAuditorium);

        given(semesterCalendar.getWeekParityOf(any(LocalDate.class))).willReturn(false);

        List<Schedule> expected = Collections.emptyList();
        given(scheduleService.updateAllWithSameTemplateId(any(Schedule.class), any(LocalDate.class))).willReturn(
                expected);
        ...
        then(scheduleService).should().updateAllWithSameTemplateId(candidate, date);
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void reschedulePermanentlyShouldThrowNotFoundExceptionIfTemplateNotFound() {
        ...
        assertThatExceptionOfType(NotFoundException.class).isThrownBy(
                () -> timetableFacade.rescheduleRecurring(schedule, LocalDate.MAX, option))
