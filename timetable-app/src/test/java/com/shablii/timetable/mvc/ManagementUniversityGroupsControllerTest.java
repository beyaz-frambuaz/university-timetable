...
class ManagementUniversityGroupsControllerTest {
    ...
    public void getGroupsShouldRequestStudentsFromServiceAndDisplayInGroups() throws Exception {
        ...
        mvc.perform(get(baseUrl))
                ...
                .andExpect(model().attribute("groupedStudents", groupedStudents))
                .andExpect(
    ...
    @Test
    public void postScheduleShouldValidateFormAndRedirectToGroupsWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postScheduleShouldRequestGroupFromServiceAndRedirectToGroupsIfNotPresent() throws Exception {
    ...
    @Test
    public void postRenameShouldValidateFormAndRedirectToGroupsWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postRenameShouldRequestGroupFromServiceAndRedirectToGroupsIfNotPresent() throws Exception {
    ...
    @Test
    public void postRenameShouldSetGroupNameRequestServiceToSaveAndRedirectToGroupsWithMessage() throws Exception {
    ...
    @Test
    public void getRemoveShouldValidateIdAndRedirectToGroupsIfInvalid() throws Exception {
    ...
    @Test
    public void getRemoveShouldRequestGroupFromServiceAndRedirectToGroupsIfNotPresent() throws Exception {
    ...
    @Test
    public void getRemoveShouldRequestServiceToDeleteAndRedirectToGroupsWithMessage() throws Exception {
    ...
    @Test
    public void postNewShouldValidateFormAndRedirectToGroupsWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postNewShouldCreateGroupRequestServiceToSaveAndRedirectToGroupsWithMessage() throws Exception {
        ...
        given(timetableFacade.saveGroup(any(Group.class))).willReturn(savedGroup);
