...
class ManagementUniversityCoursesControllerTest {
    ...
    @Test
    public void getCoursesShouldRequestFromServiceAndDisplay() throws Exception {
    ...
    @Test
    public void postScheduleShouldValidateFormAndRedirectToCoursesWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postScheduleShouldRequestCourseFromServiceAndRedirectToCoursesIfNotPresent() throws Exception {
    ...
    @Test
    public void postRenameShouldValidateFormAndRedirectToCoursesWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postRenameShouldRequestCourseFromServiceAndRedirectToCoursesIfNotPresent() throws Exception {
    ...
    @Test
    public void postRenameShouldSetCourseNameRequestServiceToSaveAndRedirectToCoursesWithMessage() throws Exception {
    ...
    @Test
    public void getRemoveShouldValidateIdAndRedirectToCoursesIfInvalid() throws Exception {
    ...
    @Test
    public void getRemoveShouldRequestCourseFromServiceAndRedirectToCoursesIfNotPresent() throws Exception {
    ...
    @Test
    public void getRemoveShouldRequestServiceToDeleteAndRedirectToCoursesWithMessage() throws Exception {
    ...
    @Test
    public void postNewShouldValidateFormAndRedirectToCoursesWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postNewShouldCreateCourseRequestServiceToSaveAndRedirectToCoursesWithMessage() throws Exception {
        ...
        given(timetableFacade.saveCourse(any(Course.class))).willReturn(savedCourse);
