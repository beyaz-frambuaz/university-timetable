...
import com.shablii.timetable.forms.utility.formatter.*;
...
class ManagementControllerTest {
    ...
    @Test
    public void getHomeShouldClearSessionRequestDayScheduleAndReturnHomeViewWithFlashMessages() throws Exception {
        ...
        then(scheduleFormatter).should().prepareDaySchedule(new SchedulePredicateNoFilter(), LocalDate.now(), false);
    }

    @Test
    public void postRebuildTimetableShouldTriggerDataGeneratorAndRedirectHome() throws Exception {
    ...
    @Test
    public void postRefreshAllDataShouldTriggerDataGeneratorAndRedirectHome() throws Exception {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "/timetable/management/schedule", "/timetable/management/schedule/reschedule",
            "/timetable/management/schedule/options" })
    public void getSchedulePagesShouldRedirectHome(String uri) throws Exception {
    ...
    @Test
    public void getTwoWeekShouldRequestFromFormatterAndDisplayTwoWeekSchedule() throws Exception {
    ...
    public void postScheduleShouldRequestAndDisplayDaySchedulePerFormRequest() throws Exception {
        ...
        RequestBuilder requestBuilder = post("/timetable/management/schedule").flashAttr("scheduleForm", scheduleForm);
        mvc.perform(requestBuilder)
                .andExpect(status().isOk())
                .andExpect(model().attribute("daySchedule", daySchedule))
                .andExpect(view().name("management/schedule/day"));

        then(scheduleFormatter).should().prepareDaySchedule(predicate, date, false);
    }
    ...
    public void postScheduleShouldRequestAndDisplayWeekSchedulePerFormRequest() throws Exception {
        ...
        then(scheduleFormatter).should().prepareWeekSchedule(predicate, date, false);
    }
    ...
    public void postScheduleShouldRequestAndDisplayMonthSchedulePerFormRequest() throws Exception {
        ...
        then(scheduleFormatter).should().prepareMonthSchedule(predicate, date, false);
    }

    @Test
    public void postScheduleShouldValidateFormRedirectToListWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void getAvailableShouldRequestFromServiceAndDisplayAvailableProfessorsAndAuditoriums() throws Exception {
        ...
        given(timetableFacade.getAvailableProfessors(any(LocalDate.class), any(Period.class))).willReturn(professors);
        given(timetableFacade.getAvailableAuditoriums(any(LocalDate.class), any(Period.class))).willReturn(auditoriums);

        mvc.perform(
                get("/timetable/management/schedule/available").queryParam("scheduleId", String.valueOf(scheduleId)))
                .andExpect(status().isOk())
                .andExpect(model().attributeExists("successAlert", "errorAlert", "changeScheduleForm"))
    ...
    @Test
    public void getAvailableShouldRequestScheduleAndThrowExceptionIfNotPresent() throws Exception {
        ...
        assertThat(exception).isPresent().containsInstanceOf(NotFoundException.class);

        then(timetableFacade).should().getSchedule(scheduleId);
    }

    @Test
    public void getAvailableShouldValidateScheduleIdAndRedirectToHomeWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postAvailableShouldRequestScheduleAndThrowExceptionIfNotPresent() throws Exception {
        ...
        MvcResult mvcResult = mvc.perform(
                post("/timetable/management/schedule/available").flashAttr("changeScheduleForm", form))
                .andExpect(status().is3xxRedirection())
                .andExpect(flash().attributeExists("errorAlert"))
                .andExpect(redirectedUrl("/timetable/management/home"))
                .andReturn();
    ...
    @Test
    public void postAvailableShouldValidateFormAndRedirectToHomeWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postAvailableShouldRequestNewAuditoriumAndRedirectToAvailableIfNotPresent() throws Exception {
        ...
        mvc.perform(post("/timetable/management/schedule/available").flashAttr("changeScheduleForm", form))
                .andExpect(status().is3xxRedirection())
                .andExpect(flash().attributeExists("errorAlert"))
                .andExpect(redirectedUrl("/timetable/management/schedule" + "/available?scheduleId=" + scheduleId));
    ...
    @Test
    public void postAvailableShouldRequestNewProfessorAndRedirectToAvailableIfNotPresent() throws Exception {
    ...
    @Test
    public void postOptionsShouldRequestScheduleAndThrowExceptionIfNotPresent() throws Exception {
        ...
        MvcResult mvcResult = mvc.perform(
                post("/timetable/management/schedule/options").flashAttr("findReschedulingOptionsForm", form))
                .andExpect(status().is3xxRedirection())
                .andExpect(flash().attributeExists("errorAlert"))
                .andExpect(redirectedUrl("/timetable/management/home"))
                .andReturn();
    ...
    @Test
    public void postOptionsShouldValidateFormAndRedirectToHomeWithErrorMessageIfInvalid() throws Exception {
    ...
    @Test
    public void postOptionsShouldRequestAndDisplayDayOptionsFromFormatter() throws Exception {
        ...
        given(optionsFormatter.prepareDayOptions(any(Schedule.class), any(LocalDate.class))).willReturn(dayOptions);

        mvc.perform(post("/timetable/management/schedule/options").flashAttr("findReschedulingOptionsForm", form))
                .andExpect(status().isOk())
                .andExpect(model().attribute("schedule", schedule))
    ...
    @Test
    public void postOptionsShouldRequestAndDisplayWeekOptionsFromFormatter() throws Exception {
        ...
        given(optionsFormatter.prepareWeekOptions(any(Schedule.class), anyInt())).willReturn(weekOptions);

        given(semesterCalendar.getSemesterWeekNumber(any(LocalDate.class))).willReturn(1);
    ...
    @Test
    public void postRescheduleShouldValidateFormAndRedirectToHomeWithErrorMessageIfInvalid() throws Exception {
        ...
        MvcResult mvcResult = mvc.perform(
                post("/timetable/management/schedule/reschedule").flashAttr("rescheduleForm", form))
                .andExpect(status().is3xxRedirection())
                .andExpect(flash().attributeExists("errorAlert"))
                .andExpect(redirectedUrl("/timetable/management/home"))
                .andReturn();
    ...
    @Test
    public void postRescheduleShouldRequestScheduleAndThrowExceptionIfNotPresent() throws Exception {
    ...
    @Test
    public void postRescheduleShouldRequestOptionAndThrowExceptionIfNotPresent() throws Exception {
        ...
        Schedule schedule = mock(Schedule.class);
        given(timetableFacade.getSchedule(anyLong())).willReturn(Optional.of(schedule));
        given(timetableFacade.getOption(anyLong())).willReturn(Optional.empty());
    ...
    @Test
    public void postRescheduleShouldRequestServiceToRescheduleOnceAndDisplayAffectedSchedule() throws Exception {
        ...
        Schedule schedule = new Schedule(scheduleId, null, date, DayOfWeek.MONDAY, Period.FIRST, auditorium, course,
                group, professor);
        given(timetableFacade.getSchedule(anyLong())).willReturn(Optional.of(schedule));

        ReschedulingOption option = mock(ReschedulingOption.class);
        given(timetableFacade.getOption(anyLong())).willReturn(Optional.of(option));

        given(timetableFacade.rescheduleSingle(any(Schedule.class), any(LocalDate.class),
                any(ReschedulingOption.class))).willReturn(schedule);
        List<Schedule> affected = Collections.singletonList(schedule);

        mvc.perform(post("/timetable/management/schedule/reschedule").flashAttr("rescheduleForm", form))
                .andExpect(status().isOk())
    ...
    public void postRescheduleShouldRequestServiceToReschedulePermanentlyAndDisplayAffectedSchedules()
        ...
        then(timetableFacade).should().getSchedule(scheduleId);
        then(timetableFacade).should().getOption(optionId);
        then(timetableFacade).should().rescheduleRecurring(schedule, date, option);
    }
