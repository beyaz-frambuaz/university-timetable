...
public class Schedule implements Comparable<Schedule> {
    ...
    public Schedule(ScheduleTemplate template, LocalDate date) {
        ...
        this(null, template, date, template.getDay(), template.getPeriod(), template.getAuditorium(),
                template.getCourse(), template.getGroup(), template.getProfessor());
    }

    public Schedule(Schedule other) {

        this(other.id, other.template, other.date, other.day, other.period, other.auditorium, other.course, other.group,
                other.professor);
    }
