...
public class CourseModelAssembler implements RepresentationModelAssembler<Course, EntityModel<Course>> {
    ...
    public EntityModel<Course> toModel(Course course) {
        ...
        return new EntityModel<>(course, linkTo(controller.findById(course.getId())).withSelfRel(),
                linkTo(controller.findCourseProfessors(course.getId())).withRel("professors"),
