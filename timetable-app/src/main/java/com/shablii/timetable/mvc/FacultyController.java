...
public class FacultyController {
    ...
    @GetMapping("/list")
    public String listProfessors(Model model, HttpSession session, @ModelAttribute("sessionExpired") String message,
    ...
    @PostMapping("/list")
    public String selectProfessor(@RequestParam("professorId") @IdValid("Professor") long professorId,
        ...
        if (!professor.isPresent()) {
            ...
            redirectAttributes.addFlashAttribute("errorAlert",
                    "Could not find professor with ID " + professorId + "! Please, try again");
    ...
    public String home(HttpSession httpSession, Model model) {
        ...
        DaySchedule daySchedule = scheduleFormatter.prepareDaySchedule(
                new SchedulePredicateProfessorId(professor.getId()), today, true);
    ...
    public String processForm(Model model, HttpSession httpSession, @ModelAttribute @Valid ScheduleForm scheduleForm) {
        ...
        switch (scheduleForm.getScheduleOption()) {
            ...
            case DAY:
                DaySchedule daySchedule = scheduleFormatter.prepareDaySchedule(
                        new SchedulePredicateProfessorId(professor.getId()), date, scheduleForm.isFiltered());
                model.addAttribute("daySchedule", daySchedule);
